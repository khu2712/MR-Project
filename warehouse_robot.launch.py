...
def generate_launch_description():
    ...
    maze_path = os.path.join(get_package_share_directory('autonomous_warehouse_robot'),'world','warehouse','model.sdf')
    config_dir = os.path.join(get_package_share_directory('autonomous_warehouse_robot'),'config')
    map_file = os.path.join(config_dir,'warehouse.yaml')
